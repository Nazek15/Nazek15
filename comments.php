...
<div class="comment-avatar"><img src="http://i9.photobucket.com/albums/a88/creaticode/avatar_1_zps8e1c80cd.jpg" alt="">
</div>
...
<div class="comments-container">
    ...
    <ul id="comments-list" class="comments-list">
        ...
        //http://localhost/WP/2022/04/18/post4/?replytocom=4#respond
        wp_list_comments(['walker' => new Display_comments()]);
...
<?php comment_form([
    'comment_field' => '<div class="mt-3 p-3 w-full">
                <textarea rows="3" class="border p-2 rounded w-full" name="comment"
                    placeholder="Write something..."></textarea>
            </div>',
    'fields' => [
        'email' => ' <div class="flex flex-wrap mx-3">
                <div class="w-full">
                    <label class="block mb-1" for="formGridCode_card">Email</label>
                    <input
        ...
        'author' => '<div class="flex space-between mx-3">
                <div class="w-full">
                    <label class="block mb-1" for="formGridCode_name">Author</label>
                    <input
                        class="w-full h-10 px-3 text-base placeholder-gray-600 border rounded-lg focus:shadow-outline"
    ...
    'submit_button' => ' <div class="flex mx-3 mt-2">
                <input class="px-4 py-1 bg-gray-800 text-white rounded font-light hover:bg-gray-700" name="%1$s"
                    type="submit" id="%2$s" value="%4$s">
            </div>',
    'class_container' => 'mb-5 w-full bg-white p-2 pt-4 rounded shadow-lg ',

    'logged_in_as' => ' <p class="mx-3 text-blue-600">' .
        sprintf(
            'Logged in as <a class="text-red-600" href="%1$s">%2$s</a>. <a href="%3$s"
