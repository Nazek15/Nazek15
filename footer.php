<footer class="bg-gray-900">
    <div class="container max-w-6xl mx-auto flex items-center px-2 py-8">
      ...
      wp_nav_menu([
        ...
        'menu_class' => 'list-reset flex justify-center flex-1 md:flex-none items-center',
        'container' => 'div',
        'container_class' => 'flex w-full pt-2 content-center justify-between md:w-1/2 md:justify-end',
      ])
      ?>
        </div>
    </div>
